...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Pastel: [Blue:}\StringTok{'#a3c6ff'}\NormalTok{, Orange:}\StringTok{'#f7ab60'}\NormalTok{, Green:}\StringTok{'#60f7a9'}\NormalTok{, Red:}\StringTok{'#fc9d94'}\NormalTok{, Purple:}\StringTok{'#bea3ff'}\NormalTok{, Brown:}\StringTok{'#d1b485'}\NormalTok{, Pink:}\StringTok{'#f7afdf'}\NormalTok{, Gray:}\StringTok{'#c4c4c4'}\NormalTok{, Yellow:}\StringTok{'#ffffaa'}\NormalTok{, LBlue:}\StringTok{'#baf6ff'}\NormalTok{]}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Deep: [Green:}\StringTok{'#5baf68'}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
that will avoid the SwttingWithCopyWarning.

\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{import}\NormalTok{ pandas }\ImportTok{as}\NormalTok{ pd}
\NormalTok{df }\OperatorTok{=}\NormalTok{ pd.DataFrame(\{}\StringTok{'Trait'}\NormalTok{:[}\StringTok{'Seed_Shape'}\NormalTok{,}\StringTok{'Seed_Shape'}\NormalTok{,}\StringTok{'Flower_Color'}\NormalTok{,}\StringTok{'Flower_Color'}\NormalTok{], }\StringTok{'Phenotype'}\NormalTok{:[}\StringTok{'Round'}\NormalTok{,}\StringTok{'Wrinkled'}\NormalTok{,}\StringTok{'Purple'}\NormalTok{,}\StringTok{'White'}\NormalTok{]\})}
